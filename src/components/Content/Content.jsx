...
const TasksPage = lazy(() => new Promise(resolve =>
  setTimeout(() => resolve(import('../../pages/Tasks/Tasks')), 1000)
))
const BudgetPage = lazy(() => new Promise(resolve =>
  setTimeout(() => resolve(import('../../pages/Budget/Budget')), 1000)
))
const SettingsPage = lazy(() => new Promise(resolve =>
  setTimeout(() => resolve(import('../../pages/Settings/Settings')), 1000)
))
